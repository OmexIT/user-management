...
import com.example.usermanagement.model.MerchantUser;
...
import com.example.usermanagement.repository.MerchantRepository;
...
public class MerchantService {
	...
	public Merchant createMerchant(MerchantDto merchantDto) {
		...
		if (merchantDto.initialUser() != null) {
			...
			MerchantUser merchantUser = new MerchantUser(merchant.getId(), MerchantUserRole.ADMIN);
	...
	public User addUserToMerchant(MerchantUserDto merchantUserDto) {
		...
		// Create merchant user relationship
		MerchantUser merchantUser = new MerchantUser(merchant.getId(), merchantUserDto.role());
		user.addMerchantUser(merchantUser);
